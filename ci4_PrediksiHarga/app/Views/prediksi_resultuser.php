...
<div class="container">
    ...
    <div class="result">
        <?php if(isset($predictions) && isset($accuracy)): ?>
            ...
            <!-- Tombol Kembali -->
            <a href="<?= base_url('PrediksiPriceUser/index') ?>" class="btn-submit">Kembali</a>
...
<script>
    function showConfusionMatrix() {
        $.ajax({
            url: "<?= base_url('/PrediksiPriceUser/plotConfusionMatrix') ?>",
            type: "GET",
    ...
    function exportToExcel() {
        $.ajax({
            url: "<?= base_url('/PrediksiPriceUser/exportToExcel') ?>",
            type: "GET",
            success: function(data) {
    ...
    //Memuat hasil prediksi saat halaman dimuat
        $(document).ready(function() {
            $.ajax({
                url: "<?= base_url('/PrediksiPriceUser/proses_prediksiharga') ?>",
                type: "POST",
                success: function(data) {
                    // Tampilkan hasil prediksi
