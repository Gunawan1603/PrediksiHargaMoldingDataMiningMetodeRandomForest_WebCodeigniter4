                            ...
                            <div class="card-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10 text-right">
                                        <a href="<?= base_url('/dataset/insert_csv'); ?>" class="btn btn-out waves-effect waves-light btn-success btn-square"><i class="fa fa-upload"></i> Insert CSV</a>
                                        <a href="<?= base_url('dataset/adddataset'); ?>" class="btn btn-out waves-effect waves-light btn-primary btn-square"><i class="fa fa-plus"></i> Add Data</a>
                                        <button onclick="deleteAllData()" class="btn btn-out waves-effect waves-light btn-danger btn-square"><i class="fa fa-trash"></i> Delete All Data</button>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $row['status'] ?></td>
                                                    <td>
                                                        <a href="<?= base_url('dataset/edit/'.$row['id']); ?>" class="btn btn-sm waves-effect waves-light btn-primary btn-outline-primary"><i class="fa fa-pencil"></i> Edit</a>
                                                        <a href="<?= base_url('dataset/delete/'.$row['id']); ?>" class="btn btn-sm waves-effect waves-light btn-danger btn-outline-danger" onclick="showLoading(); return confirm('Apakah Anda yakin ingin menghapus data ini?')"><i class="fa fa-trash"></i> Delete</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; else: ?>
                                                <tr>
