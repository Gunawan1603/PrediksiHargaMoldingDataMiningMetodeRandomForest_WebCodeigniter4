        ...
        <div class="col-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo base_url('/useradmin/register'); ?>" method="post">
                    <div class="mb-3">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <p class="text-center">Have already an account <a href="<?php echo base_url('/useradmin/login'); ?>">Login here</a><p>
                        </div>
                    </form>
                </div>
            </div>
