...
class Splitdataset extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('splitdataset', compact('title', 'link', 'datasetmold', 'trainingSet', 'testingSet'));
    }
    ...
    public function resetStatus()
   {
    ...
    return view('results_view', ['accuracy' => $accuracy, 'classificationReport' => $classificationReport,
        'mae' => $mae,
        'mape' => $mape]);
    }
