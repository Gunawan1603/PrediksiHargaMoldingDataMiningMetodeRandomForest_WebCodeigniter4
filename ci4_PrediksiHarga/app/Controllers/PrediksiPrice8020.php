    ...
    public function proses_prediksiharga()
{
    ...
    public function exportToExcel()
    {
        ...
        $sheet->setCellValue('A33', 'Atribut Label Prediksi Harga Molding :');
        ...
        $sheet->setCellValue('A40', '6. Cavity Material :');
        $sheet->setCellValue('D40', $cavity_material);
        $sheet->setCellValue('A41', '7. Core Material :');
        $sheet->setCellValue('D41', $core_material);
        $sheet->setCellValue('A42', '8. Slide System :');
        $sheet->setCellValue('D42', $slide_system);
        $sheet->setCellValue('A43', '9. Lift Core System :');
