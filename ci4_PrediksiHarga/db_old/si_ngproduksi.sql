...
--
-- Host: localhost:3307
-- Waktu pembuatan: 16 Des 2023 pada 16.44
...
--
-- Dumping data untuk tabel `ngproduk`
--

INSERT INTO `ngproduk` (`idNG`, `tanggal`, `bulan`, `tahun`, `idProduk`, `qty`, `ng`, `namapelapor`, `bagian`) VALUES
(1, 2023, 0, 0000, '', 1, 'Burry', 'Gunawan', 'QC'),
(2, 2023, 0, 0000, '', 1, 'Scratch', 'Bagus', 'WH'),
(3, 2023, 0, 0000, '', 1, 'Brocken', 'Rudi', 'Assembling'),
(4, 2023, 0, 0000, '', 1, 'Brocken', 'Rudi', 'Assembling');
...
--
-- Indeks untuk tabel `ngproduk`
--
ALTER TABLE `ngproduk`
  ADD PRIMARY KEY (`idNG`);
...
--
-- AUTO_INCREMENT untuk tabel `ngproduk`
--
ALTER TABLE `ngproduk`
  MODIFY `idNG` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
